...
日期：2026-09-10。状态：用户已确认方向，本次只记录需求，不实现。

后续具体功能见[会话贴纸、跨会话引用与上下文关系图需求](2026-09-10-session-context-graph-requirements.md)及[插件、引擎改动清单](2026-09-10-session-context-graph-plugin-changes.md)。具体引用以被引用 AI 回复完成位置为上限，通过后端工具按需读取；不要求默认复制或摘要整个上游。
