...
2026-09-15 更新：[扩展归属目录与会话阅读器](2026-09-15-extension-ownership-and-session-reader.md)明确一个业务 Adapter 一个面板、按所属会话和工作区折叠浏览，以及 Core 轻量引用镜像。本文件早期“每个数据域分别显示面板”的描述以该更新为准。
