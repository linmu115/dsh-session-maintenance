...
2026-09-15 新增需求确认：LLM 管理自身主干、用户请求索引、活动披露窗口与原生上下文释放，详见[原生 Agent 上下文管理补充规格](2026-09-15-native-agent-context-management.md)。这部分尚未实现，范围仅为 DSH 原生 Agent，托管引擎暂不纳入；不能与上述已交付功能混为一批。
