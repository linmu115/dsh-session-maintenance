...
本记录保留 2026-09-17 首版实现时的状态。2026-09-19 后续关联、普通同步排除及增量预算修复已单独整理为 [[HIST-learning-association-repair]]，附对应公开事件来源索引；当前部署与验收以 [[IMP-learning-roundtrip]]、[[VER-learning-roundtrip]] 为准。
