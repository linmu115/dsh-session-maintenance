...
const stages = ["run.lease", "projection.materialize", "projection.delta-apply", "runtime.persistence.attach", "session.append.commit", "session.derivation.create", "projection.cross-version.verify", "projection.cache-retained", "reference.index", "reference.roundtrip.verify", "run.shutdown-recovery"] as const;
