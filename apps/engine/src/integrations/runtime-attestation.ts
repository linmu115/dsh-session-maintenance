...
const schema=z.strictObject({schemaVersion:z.literal(1),instanceId:z.string(),profileId:z.string(),homeRoot:z.string(),adapterId:z.literal("dsh-0.1.5"),formatId:z.literal("dsh-0.1.5-v3-jsonl-zstd-v1"),runtimeVersion:z.literal("0.1.5-rc.2"),engineVersion:z.literal("0.1.32-rc2.2"),launcherCapabilityDigest:z.string().regex(/^[a-f0-9]{64}$/u),runtimeCapabilities:z.array(z.string()),files:z.array(fileSchema)});
