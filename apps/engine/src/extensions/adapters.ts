...
export const thoughtDagAdapter: ExtensionDataAdapter = {
  capabilities,
  namespace: "thoughtdag", label: "ThoughtDAG", pluginVersions: ["0.4.11", "0.4.14-rc2.1", "0.4.14-rc2.2", "0.4.14-rc2.3", "0.4.14-rc2.4", "0.4.14-rc2.5", "0.4.14-rc2.6"], schemaVersions: [1, 2],
  validate(content) {
