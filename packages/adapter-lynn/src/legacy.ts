...
const obsidianPanel = { id: "lynn", label: "Lynn adapter" };
...
export const obsidianLinksAdapter: ExtensionDataAdapter = {
  ...
  namespace: "obsidian-links", label: "知识链接", pluginVersions: ["0.3.23", "0.6.4-rc2.4", "0.6.4-rc2.5", "0.6.4-rc2.6", "0.6.4-rc2.7", "0.7.0-rc2.1", "0.7.0-rc2.3", "0.7.0-rc2.4", "0.7.0-rc2.5", "0.7.0-rc2.8"], schemaVersions: [1, 2],
...
export const stickerAdapter: ExtensionDataAdapter = {
  ...
  capabilities, namespace: 'stickers', label: '会话贴纸', pluginVersions: ['0.7.3-rc2.9', '0.7.3-rc2.10', '0.7.3-rc2.11', '0.7.3-rc2.12', '0.7.3-rc2.13', '0.7.3-rc2.14', '0.7.3-rc2.15', '0.7.3-rc2.16', '0.7.3-rc2.17', '0.7.3-rc2.18', '0.7.3-rc2.19', '0.7.4-rc2.1', '0.7.4-rc2.2', '0.7.4-rc2.3', '0.7.4-rc2.5', '0.7.4-rc2.6', '0.7.4-rc2.11'], schemaVersions: [1],
...
export const upstreamAdapter: ExtensionDataAdapter = {
  ...
  capabilities,namespace:SESSION_CONTEXT_NAMESPACE,label:"跨会话上游引用",pluginVersions:["0.3.12-rc2.1","0.3.12-rc2.2","0.3.12-rc2.3","0.3.12-rc2.4","0.3.12-rc2.5","0.3.12-rc2.6","0.3.12-rc2.7","0.3.12-rc2.8","0.3.12-rc2.9","0.3.12-rc2.10","0.3.12-rc2.11","0.3.12-rc2.12","0.3.12-rc2.19", "0.3.12-rc2.20", "0.3.12-rc2.21", "0.3.12-rc2.28"],schemaVersions:[1],
...
export const annotationRecordsAdapter: ExtensionDataAdapter = {
  ...
  pluginVersions: ["0.3.12-rc2.9", "0.3.12-rc2.10","0.3.12-rc2.11","0.3.12-rc2.12","0.3.12-rc2.19", "0.3.12-rc2.20", "0.3.12-rc2.21", "0.3.12-rc2.28"], schemaVersions: [1],
...
export const nativeContextAdapter: ExtensionDataAdapter = {
  ...
  pluginVersions: ["0.3.12-rc2.11","0.3.12-rc2.12","0.3.12-rc2.19", "0.3.12-rc2.20", "0.3.12-rc2.21", "0.3.12-rc2.28"], schemaVersions: [1],
  capabilities: { ...capabilities, write: false, delete: false, restore: false },
...
export const lynnExtensionAdapters = [thoughtDagAdapter, annotationAdapter, obsidianLinksAdapter, upstreamAdapter, stickerAdapter, annotationRecordsAdapter, nativeContextAdapter] as const;
