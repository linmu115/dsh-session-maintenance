/** Adds the reference.index breakpoint used by the unified native identity read model. */
...
ALTER TABLE run_status_events RENAME TO run_status_events_v13;
...
SELECT
  ...
  parent_event_id, span_id, error_code, duration_ms, diagnostic_detail_ref,
  event_json
FROM run_status_events_v13
ORDER BY sequence;

DROP TABLE run_status_events_v13;
